...
import nextstep.security.authentication.AuthenticationManagerBuilder;
import nextstep.security.authentication.AuthenticationProvider;
import nextstep.security.config.DefaultSecurityFilterChain;
import nextstep.security.config.annotation.configurer.*;
...
public class HttpSecurity {
    ...
    private DefaultSecurityFilterChain performBuild() {
        ...
        for (OrderedFilter filter : this.filters) {
            sortedFilters.add(filter.filter);
        }
    ...
    public HttpSecurity formLogin(Customizer<UsernamePasswordAuthenticationConfigurer> formLoginCustomizer) {
        formLoginCustomizer.customize(getOrApply(new UsernamePasswordAuthenticationConfigurer()));
        return HttpSecurity.this;
    }
